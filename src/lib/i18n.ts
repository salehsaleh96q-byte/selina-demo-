...
const ar: Dictionary = {
  ...
  home: {
    ...
    heroSubtitle:
      "عناية متخصصة بالبشرة وتجميل غير جراحي على يد الدكتورة زهرة محمد في كركوك، العراق.",
    ctaBook: "احجزي موعدك",
  ...
  about: {
    ...
    storyHeading: "قصتنا",
    story: [
      "وُلدت Selina Derma من إيمان بسيط: أن العناية بالبشرة فنّ وعلم في آنٍ واحد. أسّستها الدكتورة زهرة محمد في كركوك لتقدّم تجربة تجميلية تجمع بين الاحتراف الطبي والذوق الراقي.",
